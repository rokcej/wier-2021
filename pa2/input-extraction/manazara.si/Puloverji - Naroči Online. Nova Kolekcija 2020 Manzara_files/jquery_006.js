...
optionText='<img src="'+option.filter(':first').attr('data-image')+'"/>'+optionText;if(optionSelected.length){optionText=optionSelected.text();if(optionSelected.attr('data-image'))
...
var selectbox=$('<span class="selectbox '+styleClass+'" style="display:inline-block;position:relative">'+
